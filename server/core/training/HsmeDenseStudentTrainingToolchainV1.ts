...
function launchSpecDigestPayload(
  ...
  return {
    ...
    entrypointRelativePath:value.entrypointRelativePath,
    entrypointFileSha256:value.entrypointFileSha256,
    dependencyLockRelativePath:value.dependencyLockRelativePath,
    ...
    checkpointWritten:value.checkpointWritten,
