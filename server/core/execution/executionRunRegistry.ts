export const EXECUTION_RUN_CAPABILITIES = Object.freeze(['LOCAL_EXECUTION','CREATIVE_EXECUTION','WORKFLOW_CONTINUATION','WORKFLOW_STEP'] as const);
export const EXECUTION_RUN_AUTHORITY_KINDS = Object.freeze(['LOCAL_EXECUTION_TICKET','CREATIVE_EXECUTION','WORKFLOW_CONTINUATION','WORKFLOW_INTERNAL_STEP'] as const);
