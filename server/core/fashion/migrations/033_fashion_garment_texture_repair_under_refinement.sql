...
-- Forward-compatible repair for F4-owned texture FINAL schema after later F5
-- refinement columns/rows exist. This migration deliberately does NOT replace
-- canonical_image_artifacts_lineage_shape_check: the latest lineage extension
-- owns that global cross-operation constraint.
