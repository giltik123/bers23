...
export const PRODUCTION_TARGET_SELECTION_VERSION = '6.42C2.1';
...
export const productionTargetSelection: TargetSelectorPort = Object.freeze({
  select(operation) {
    ...
    if (operation.type === 'verify' || operation.type === 'segment' || operation.type === 'BACKGROUND_ISOLATION') return 'LOCAL';
    return 'BLOCKED';
  },
});
