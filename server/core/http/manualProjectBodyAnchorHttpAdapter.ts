...
function publicResult(value: ManualProjectBodyAnchorAcquisitionResult) {
  ...
  if (anchorSet.projectId !== value.projectId || !/^[1-9][0-9]*$/.test(anchorSet.acquisitionSequence)) {
...
function exactBody(value: unknown): RequestBody {
  ...
  if (typeof record.sourceArtifactId !== 'string' || !record.sourceArtifactId.trim()) {
