...
export function loadCoreServerConfig(env: NodeJS.ProcessEnv = process.env): CoreServerConfig {
  ...
  return Object.freeze({
    ...
    allowedWebOrigins: Object.freeze(allowedWebOrigins), hardBudgetCredits: integer('HARD_BUDGET_CREDITS', 1, 1, 1000), creditsPerEdit: integer('CREDITS_PER_EDIT', 1, 1, 1000),
