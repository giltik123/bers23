...
export async function verifyResourceFragment({
  ...
  if(
    ...
    || evidence.costEvidenceSha256!==record.costEvidenceSha256
  ...
  if(!Array.isArray(evidence.warmLatencySamplesMicros)||evidence.warmLatencySamplesMicros.length<1||evidence.warmLatencySamplesMicros.length>4096){
