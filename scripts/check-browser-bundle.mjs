...
const forbidden=['require("sharp")','from"sharp"',"from'sharp'",'node-postgres','BEGIN PRIVATE KEY','PRIVATE KEY-----','JWT_SECRET','server/core/providers','.onnx','mobilesam-encoder','mobilesam-decoder'];
