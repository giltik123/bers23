...
await cp('server/core/projects/migrations/005_canonical_project_history_and_versions.sql', 'dist-server/migrations/005_canonical_project_history_and_versions.sql');
