...
export interface CreativePlannerConfigSnapshot { readonly minimumIntentConfidence: number; readonly minimumTargetConfidence: number; readonly maximumPreservationRisk: number; readonly compositeExecutionEnabled: boolean }
