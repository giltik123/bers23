...
export interface CreativePlanReplayMetadata { readonly schemaVersion: string; readonly plannerVersion: string; readonly operationRulesVersion: string; readonly scoringPolicyVersion: string; readonly verificationPolicyVersion: string; readonly fallbackPolicyVersion: string; readonly inputArtifacts: readonly CreativePlanArtifactSnapshot[]; readonly selectedCandidateId?: string; readonly rejectedCandidates: readonly Readonly<{ id: string; reasonCodes: readonly string[] }>[] }
export interface CreativePlanExplanation { readonly selectedCandidate?: Readonly<{ id: string; reasonCodes: readonly string[] }>; readonly rejectedCandidates: readonly Readonly<{ id: string; reasonCodes: readonly string[] }>[]; readonly materialConstraints: readonly string[]; readonly uncertaintyReasons: readonly string[]; readonly requiredVerificationIds: readonly string[]; readonly fallbackPaths: readonly Readonly<{ id: string; action: FallbackAction; reasonCode: string }>[]; readonly versions: Readonly<{ planner: string; schema: string; verificationPolicy: string; fallbackPolicy: string }> }
