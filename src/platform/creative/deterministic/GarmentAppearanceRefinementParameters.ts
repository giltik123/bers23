...
/**
 * Browser/Node-safe closed normalization for the F5a v1 producer document.
 *
 * V1 deliberately contains no prompt, model, provider, seed, steps, user mask,
 * execution identity or financial provenance. Those concerns cannot be smuggled
 * into canonical image lineage through an open producer-parameter object.
 * Durable SHA-256 authority remains server-side.
 */
