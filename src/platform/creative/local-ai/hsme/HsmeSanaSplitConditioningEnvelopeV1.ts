 ...
 * It proves tensor identity and shape; it grants no production execution,
 * model, or authority rights and intentionally never accepts or persists the raw prompt.
 */
