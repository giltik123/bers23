...
export interface CreativeProvider { readonly name: string; supports(capability: string): boolean; execute(request: ProviderRequest, signal?: AbortSignal): Promise<ProviderResult> }
