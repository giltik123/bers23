...
export class CreativeDecisionModel {
  ...
  snapshot() { return immutable({ active: this.active.version(), shadow: this.shadowModel?.version(), shadowV2: this.shadowV2?.version(), v2: this.v2.version(), registry: this.registry.list(), shadowDecisions: [...this.shadowLog] }); }
