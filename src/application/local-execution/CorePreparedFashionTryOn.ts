 ...
 * identity and byte-exact admission decision.
 */
export class CorePreparedGarmentMeshWarp {
  ...
  async run(descriptorValue: unknown): Promise<PreparedFashionTryOnExecutionResult> {
    const descriptor = requireUsableFashionTryOnPreparedExecutionDescriptor(descriptorValue, FASHION_TRYON_MESH_PHASE, this.now());
...
export class CorePreparedGarmentTextureComposite {
  ...
  async run(descriptorValue: unknown): Promise<PreparedFashionTryOnExecutionResult> {
    const descriptor = requireUsableFashionTryOnPreparedExecutionDescriptor(descriptorValue, FASHION_TRYON_TEXTURE_PHASE, this.now());
