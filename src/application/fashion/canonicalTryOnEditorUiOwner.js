...
/**
 * Pure Editor-level owner for canonical Try-On UI lifecycle.
 *
 * Editor can keep one instance in a ref while ResultCompare temporarily
 * unmounts the Outfit panel. Production controller composition is injected;
 * the owner publishes only safe UI snapshots and never exposes controller,
 * runtime, session or request identity.
 */
