...
// Advisory-only Creative Studio. Canonical Outfit authority now exists, but
// Outfit-aware recommendations remain disabled until Creative receives its own narrow read cutover.
