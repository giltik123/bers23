...
test('F4b.6b.4b phase substitution fails closed before candidate upload', async () => {
...
test('F4b.6b.4b malformed browser candidate fields fail before durable ticket lookup', async () => {
  const h = harness(meshTicket());
  const invalid = [
